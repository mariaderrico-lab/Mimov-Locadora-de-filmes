...
class LocacaoController
{
    public function alugar($dados)
    {
        ...
        try {
            ...
            $sql = "SELECT quantidade_disponivel FROM filmes WHERE id = :filme_id";
            ...
            $sql = "INSERT INTO locacoes (filme_id, usuario_id, status)
                    VALUES (:filme_id, :usuario_id, 'alugado')";
            $stmt = $pdo->prepare($sql);
            $stmt->execute([
                ':filme_id' => $filme_id,
                ':usuario_id' => $usuario_id
            ])
            $sqlFilme = "UPDATE filmes
